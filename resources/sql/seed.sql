...
INSERT INTO auctions ("name","description",species_name,age,starting_price,buyout_price,current_price,ending_date,rating_seller,id_category,id_main_color,id_dev_stage,id_payment_method,id_shipping_method,id_seller,id_winner, id_status) VALUES 
    ('Brett','vitae nibh. Donec est mauris, rhoncus id, mollis nec, cursus a, enim. Suspendisse aliquet, sem','Jorden',6,599,13892,2998,'2020-04-30',NULL,1,4,1,1,2,42,NULL, 0),
    ('Michael','odio. Phasellus at augue id ante dictum cursus. Nunc mauris elit, dictum eu, eleifend nec, malesuada ut, sem. Nulla','Kylan',14,103,7313,2257,'2020-11-30',NULL,6,2,4,1,1,43,NULL, 0),
    ('Cleo','non, egestas a, dui. Cras pellentesque. Sed dictum. Proin eget odio. Aliquam vulputate','Sylvester',11,704,8681,6657,'2020-05-05',NULL,2,7,2,1,3,42,NULL, 0),
    ('Ross','tristique senectus et netus et malesuada fames ac turpis egestas. Fusce aliquet magna a neque.','Linus',6,111,9113,4449,'2020-05-19',NULL,6,5,2,2,3,35,NULL, 0),
    ('Clementine','sem. Pellentesque ut ipsum ac mi eleifend egestas. Sed pharetra, felis eget varius ultrices, mauris ipsum porta elit, a feugiat','Sydnee',11,71,7457,1475,'2020-05-02',NULL,2,1,5,1,2,41,NULL,0),
    ('Elliott','porttitor eros nec tellus. Nunc lectus pede, ultrices a, auctor non, feugiat nec, diam. Duis mi enim, condimentum','Joy',1,898,11728,1376,'2020-06-30',NULL,2,3,3,2,2,32,NULL,0),
    ('Buffy','montes, nascetur ridiculus mus. Proin vel arcu eu odio tristique pharetra. Quisque ac','Ashton',3,892,11497,5372,'2020-05-05',4,4,5,4,2,3,34,20,1),
    ('Kennedy','metus urna convallis erat, eget tincidunt dui augue eu tellus. Phasellus elit pede, malesuada','Logan',15,549,14170,3679,'2020-07-21',NULL,1,3,4,2,1,34,NULL,0),
    ('Leah','felis. Nulla tempor augue ac ipsum. Phasellus vitae mauris sit','Freya',1,946,14533,3089,'2020-07-03',NULL,6,6,3,1,1,44,NULL,0),
    ('Cruz','nibh. Phasellus nulla. Integer vulputate, risus a ultricies adipiscing, enim mi','Alec',1,293,13098,2780,'2020-06-24',NULL,6,2,1,2,1,49,NULL,0),
    ...
    ('Jelani','non, hendrerit id, ante. Nunc mauris sapien, cursus in, hendrerit consectetuer, cursus et, magna. Praesent interdum','Gannon',7,494,14401,5747,'2020-01-13',4,3,6,5,2,1,33,26,1),
    ('Garth','pretium et, rutrum non, hendrerit id, ante. Nunc mauris sapien, cursus in, hendrerit consectetuer, cursus et,','Kyle',3,513,13391,3031,'2020-10-06',NULL,6,1,4,1,3,46,NULL,0),
    ('Raja','ullamcorper, velit in aliquet lobortis, nisi nibh lacinia orci, consectetuer euismod est arcu ac orci. Ut semper pretium neque. Morbi','Lani',6,565,12840,1515,'2020-04-28',NULL,3,4,1,2,2,50,NULL,0),
    ...
    ('Stewart','amet, consectetuer adipiscing elit. Aliquam auctor, velit eget laoreet posuere, enim nisl','Geoffrey',4,592,7582,5397,'2020-06-01',NULL,6,2,4,1,2,47,NULL,0),
    ('Deacon','feugiat. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam auctor, velit eget laoreet posuere, enim nisl elementum','Clio',12,135,12396,5688,'2020-02-21',4,5,2,5,2,3,50,11,1),
    ...
    ('Patrick','ridiculus mus. Donec dignissim magna a tortor. Nunc commodo auctor velit. Aliquam nisl. Nulla eu neque pellentesque massa','Arsenio',2,697,8201,5348,'2020-05-12',NULL,6,6,3,2,2,49,NULL,0),
    ('Jakeem','felis, adipiscing fringilla, porttitor vulputate, posuere vulputate, lacus. Cras interdum. Nunc sollicitudin commodo ipsum. Suspendisse non leo.','Keelie',2,890,7622,6616,'2020-02-13',5,6,1,2,1,2,48,22,1),
    ('Gareth','consectetuer ipsum nunc id enim. Curabitur massa. Vestibulum accumsan neque et nunc. Quisque ornare tortor at risus. Nunc','Chandler',14,675,13898,3348,'2020-03-23',4,3,1,3,2,2,42,19,1),
    ...
    ('Amelia','Curabitur consequat, lectus sit amet luctus vulputate, nisi sem semper erat, in consectetuer ipsum nunc id enim. Curabitur massa.','Gavin',9,317,14259,6220,'2020-04-28',NULL,2,2,4,1,3,38,NULL,0),
    ('Beck','ultrices. Vivamus rhoncus. Donec est. Nunc ullamcorper, velit in aliquet lobortis, nisi nibh lacinia orci, consectetuer euismod est','Renee',11,289,7274,1080,'2020-06-05',NULL,6,3,2,2,1,40,NULL,0),
    ...
    ('Guy','pede. Suspendisse dui. Fusce diam nunc, ullamcorper eu, euismod ac, fermentum vel, mauris. Integer sem elit, pharetra','Jordan',14,722,9702,3991,'2020-01-17',3,1,4,1,1,1,33,21,1),
    ...
    ('Erica','magnis dis parturient montes, nascetur ridiculus mus. Proin vel arcu eu odio tristique pharetra. Quisque ac libero nec ligula','Dorothy',2,32,9578,2737,'2020-10-21',NULL,4,5,4,1,2,40,NULL,0),
    ('Ginger','felis. Nulla tempor augue ac ipsum. Phasellus vitae mauris sit amet lorem semper auctor. Mauris vel turpis. Aliquam adipiscing','Cruz',9,93,14455,2111,'2020-01-05',1,1,3,5,1,3,34,29,1);
