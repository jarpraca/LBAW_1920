...
INSERT INTO auctions ("name","description",species_name,age,starting_price,buyout_price,current_price,ending_date,rating_seller,id_category,id_main_color,id_dev_stage,id_payment_method,id_shipping_method,id_seller,id_winner, id_status) VALUES 
    ('Brett','vitae nibh. Donec est mauris, rhoncus id, mollis nec, cursus a, enim. Suspendisse aliquet, sem','Jorden','6 years',599,13892,2998,'2020-04-30',NULL,1,4,1,1,2,42,NULL, 0),
    ...
    ('Cleo','non, egestas a, dui. Cras pellentesque. Sed dictum. Proin eget odio. Aliquam vulputate','Sylvester','11 months',704,8681,6657,'2020-05-05',NULL,2,7,2,1,3,42,NULL, 0),
    ('Ross','tristique senectus et netus et malesuada fames ac turpis egestas. Fusce aliquet magna a neque.','Linus','6 years',111,9113,4449,'2020-05-19',NULL,6,5,2,2,3,35,NULL, 0),
    ('Clementine','sem. Pellentesque ut ipsum ac mi eleifend egestas. Sed pharetra, felis eget varius ultrices, mauris ipsum porta elit, a feugiat','Sydnee','11 years',71,7457,1475,'2020-05-02',NULL,2,1,5,1,2,41,NULL,0),
    ...
    ('Buffy','montes, nascetur ridiculus mus. Proin vel arcu eu odio tristique pharetra. Quisque ac','Ashton','3 years',892,11497,5372,'2020-05-05',4,4,5,4,2,3,34,20,1),
    ...
    ('Keith','Fusce mi lorem, vehicula et, rutrum eu, ultrices sit amet,','Maxwell','7 years',508,13764,3711,'2020-04-29',NULL,5,1,4,2,3,35,NULL,0),
    ...
    ('Troy','ridiculus mus. Aenean eget magna. Suspendisse tristique neque venenatis lacus. Etiam bibendum fermentum metus. Aenean sed pede nec ante','Nichole','10 years',956,9538,4886,'2020-04-23',NULL,1,4,5,2,2,48,NULL,0),
    ('Thaddeus','quis urna. Nunc quis arcu vel quam dignissim pharetra. Nam ac nulla. In tincidunt congue turpis. In condimentum.','Steel','5 years',232,8737,1528,'2020-05-06',NULL,2,1,3,1,1,34,NULL,0),
    ...
    ('Faith','suscipit, est ac facilisis facilisis, magna tellus faucibus leo, in lobortis tellus justo sit amet nulla. Donec non justo. Proin','Gary','3 years',107,11486,2201,'2020-05-08',NULL,4,6,2,2,3,43,NULL,0),
    ...
    ('Raja','ullamcorper, velit in aliquet lobortis, nisi nibh lacinia orci, consectetuer euismod est arcu ac orci. Ut semper pretium neque. Morbi','Lani','6 years',565,12840,1515,'2020-04-28',NULL,3,4,1,2,2,50,NULL,0),
    ('Emmanuel','sem egestas blandit. Nam nulla magna, malesuada vel, convallis in, cursus et, eros. Proin ultrices. Duis','Kato','8 years',151,8110,1761,'2020-05-19',NULL,2,3,4,2,3,37,NULL,0),
    ('Demetria','magna nec quam. Curabitur vel lectus. Cum sociis natoque penatibus et magnis dis','Erich','4 years',122,11762,6346,'2020-05-15',NULL,2,4,5,1,2,41,NULL,0),
    ...
    ('Willa','Donec tincidunt. Donec vitae erat vel pede blandit congue. In','Elmo','5 years',621,7317,2290,'2020-04-24',NULL,2,7,1,1,3,44,NULL,0),
    ('Stewart','amet, consectetuer adipiscing elit. Aliquam auctor, velit eget laoreet posuere, enim nisl','Geoffrey','4 years',592,7582,5397,'2020-06-01',NULL,6,2,4,1,2,47,NULL,0),
    ...
    ('Melissa','commodo at, libero. Morbi accumsan laoreet ipsum. Curabitur consequat, lectus sit','Phillip','5 years',206,14538,6959,'2020-06-08',NULL,3,7,3,2,3,40,NULL,0),
    ('Patrick','ridiculus mus. Donec dignissim magna a tortor. Nunc commodo auctor velit. Aliquam nisl. Nulla eu neque pellentesque massa','Arsenio','2 years',697,8201,5348,'2020-05-12',NULL,6,6,3,2,2,49,NULL,0),
    ...
    ('Baxter','Quisque tincidunt pede ac urna. Ut tincidunt vehicula risus. Nulla eget metus eu erat','Anne','4 years',877,10301,3249,'2020-04-29',NULL,6,4,1,1,3,44,NULL,0),
    ('Amelia','Curabitur consequat, lectus sit amet luctus vulputate, nisi sem semper erat, in consectetuer ipsum nunc id enim. Curabitur massa.','Gavin','9 years',317,14259,6220,'2020-04-28',NULL,2,2,4,1,3,38,NULL,0),
    ('Beck','ultrices. Vivamus rhoncus. Donec est. Nunc ullamcorper, velit in aliquet lobortis, nisi nibh lacinia orci, consectetuer euismod est','Renee','11 years',289,7274,1080,'2020-06-05',NULL,6,3,2,2,1,40,NULL,0),
    ('Hedwig','velit. Aliquam nisl. Nulla eu neque pellentesque massa lobortis ultrices. Vivamus rhoncus. Donec est. Nunc','Emi','11 years',889,14626,6131,'2020-04-21',NULL,3,4,2,2,3,38,NULL,0),
    ...
    ('Kevin','nisl. Maecenas malesuada fringilla est. Mauris eu turpis. Nulla aliquet.','Ariana','7 years',944,9565,2329,'2020-05-02',NULL,6,1,3,2,1,41,NULL,0),
    ...
    ('Hanna','gravida mauris ut mi. Duis risus odio, auctor vitae, aliquet nec, imperdiet','Hector','3 years',97,11498,1673,'2020-04-23',NULL,4,7,5,2,2,40,NULL,0),
